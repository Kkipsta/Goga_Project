...
const Posts = ({ userData, fetchUsers }) => {
  ...
  }, [email, fetchUsers, history, password]);
...
export default connect(mapStateToProps, mapDispatchToProps)(memo(Posts));
