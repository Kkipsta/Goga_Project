...
const Resources = ({ resourcesData, fetchResources }) => {
  ...
  useEffect(() => {
    ...
    fetchResources();
     ...
     if (checkIfUserExists(email, password) === false) {
       history.push("/");
     }
    
  }, [email, fetchResources, history, password]);
            ...
            >
              ...
              <div className="flex sm:flex-1 flex-col gap-2 p-1">
                ...
                <p className="text-gray-500 text-sm sm:text-base line-clamp-3">
                  This is the desctiption for your card. This is really really
                ...
                <div className="flex gap-4 mt-auto">
                  ...
                  <button style={{color:`${el.color}`}} className="ml-auto flex items-center gap-1 sm:text-lg border border-gray-300 px-3 py-1 rounded-full hover:bg-gray-50 transition-colors focus:bg-gray-100 focus:outline-none focus-visible:border-gray-500">
                    <span>Read more</span>
                  </button>
                </div>
              </div>
